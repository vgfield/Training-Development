...
![Bad management](./images/slide 1.png)

## When we open up the catch-all folder

- At a minimum, at least versions have different date associated with them

![Bad management](./images/slide 2.png)
...
- By following these steps, we now have all these things simultaneously: 
  ...
  - A new folder where everything related to our project will live 
